...
public class MyCustomAdapter extends ArrayAdapter<CountryModel> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView last_update = view.findViewById(R.id.last_update);
        TextView kasus_up = view.findViewById(R.id.kasus_up);
        TextView sembuh = view.findViewById(R.id.sembuh);
        TextView meninggal = view.findViewById(R.id.meninggal);

        kasus_up.setText(countryModelsListFiltered.get(position).getTodayCases());
        sembuh.setText(countryModelsListFiltered.get(position).getTodayRecovered());
        meninggal.setText(countryModelsListFiltered.get(position).getTodayDeaths());
        last_update.setText(createDate(Long.parseLong(countryModelsListFiltered.get(position).getTimestamp())).toString());
    ...
    public Filter getFilter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                CountryActivity.countryModelsList = countryModelsListFiltered;
